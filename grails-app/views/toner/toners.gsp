...
<body>
    <main class="tabla">
        <h1 class="centrar-texto">Toner</h1>
                ...
                <g:if test="${it.cantidad <= it.stockCritico}">
                    <div class="contenido-tabla ${critico}">
                        <ul class="fila">
                            ...
                            <li class="operacion">
                                <g:link class="btn-body btn-atencion" controller="toner" action="bajaToner" id="${it.id}">Eliminar</g:link>
                                <g:link class="btn-body btn-atencion" controller="compra" action="compraToner" id="${it.id}">Comprar</g:link>
                                <g:link class="btn-body btn-atencion" controller="entrega" action="entregaToner" id="${it.id}">Entregar</g:link>
                            </li>
                        </ul>
                    </div>
                </g:if>
